...
SELECT	
        ...
        getDiseaseStatusDescription(yStatusID) AS yStatus,
		getDiseaseStatusDescription(rStatusID) AS rStatus,
        getDiseaseStatusDescription(uStatusID) AS uStatus,
        getDiseaseStatusDescription(bStatusID) AS bStatus
FROM pandemic
...
(
    ...
    cityKey		CHAR(4) NOT NULL DEFAULT "atla", -- players begin in Atlanta
